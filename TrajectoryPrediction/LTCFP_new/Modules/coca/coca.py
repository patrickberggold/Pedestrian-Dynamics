...
class CoCa(nn.Module):
    def __init__(
        ...
        *,
        ...
        if not img_encoder:
            ...
            vit = ImgBackbonePretrained()
            image_dim = vit._modules['backbone'].config.hidden_size
            
            img_encoder = Extractor(vit, return_embeddings_only=True, detach=False)
    ...
    def embed_text(self, text):
        ...
        text_tokens, text_cls_tokens = text_tokens[:, :-1], text_tokens[:, -1] # text_tokens: 4, 512, 512 ==> 4, 511, 512 and 4, 512
    ...
    def embed_image(self, images=None, image_tokens=None):
        ...
        return img_queries[:, 0], img_queries[:, 1:] # 4, 257, 512 ==> 4, 512 and 4, 256, 512
