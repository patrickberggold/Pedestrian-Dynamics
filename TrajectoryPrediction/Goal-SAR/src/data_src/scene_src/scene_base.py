...
class Scene_base(object):
    ...
    def __init__(self):
        ...
        self.dataset_folder = ""
        self.path_to_root = os.path.join(data_utils.get_data_location(), 'Goal-SAR')
    ...
    def _load_extra_data(self):
        ...
        self.semantic_map_pred = self._load_semantic(semantic='pred') # this one is loaded as 'tensor_image'
