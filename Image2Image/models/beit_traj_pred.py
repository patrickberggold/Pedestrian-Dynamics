import torch
from transformers import BeitForSemanticSegmentation, BeitConfig, BeitModel, BeitFeatureExtractor
from torch.nn import functional as F

class BeITTraj(torch.nn.Module):
    def __init__(self, mode, output_channels, relu_at_end, p_dropout, num_heads) -> None:
        ...
        self.model.decode_head.classifier = torch.nn.Conv2d(self.model.config.hidden_size, self.output_channels, kernel_size=1)
